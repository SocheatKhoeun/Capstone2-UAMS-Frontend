      ...
      <div class="table-container">
        ...
        <div class="table-toolbar">
          <div class="toolbar-left">
            ...
            <div class="table-subtitle">Manage and organize your departments</div>
          </div>
          ...
          <v-table class="modern-table" fixed-header height="500">
            ...
            <tbody>
              <tr v-for="department in paginatedDepartments" :key="department.id" class="modern-table-row">
                ...
                <!-- Only show department name + avatar -->
                ...
                <td class="modern-table-cell">
                  <div class="date-info">
                    ...
                    <div class="date-secondary">
                      {{ formatTime(department.created_at) }}
                    </div>
                  </div>
                </td>
                ...
                <td class="modern-table-cell">
                  <div class="date-info">
                    ...
                    <div class="date-primary">
                      {{ formatDate(department.update_at ?? department.updated_at) }}
                    </div>
                    <div class="date-secondary">
                      {{ formatTime(department.update_at ?? department.updated_at) }}
                    </div>
                  </div>
                </td>
    ...
    <v-dialog v-model="deleteDialog" max-width="420" persistent>
      <v-card class="delete-dialog" elevation="24">
        <div class="delete-header">
          ...
          <h2 class="delete-title">Delete Department</h2>
...
const departments = computed(() => adminDepartmentsStore.departments);
...
const openCreateDialog = () => {
  isEdit.value = false;
  Object.assign(formData, { global_id: "", name: "", active: true });
