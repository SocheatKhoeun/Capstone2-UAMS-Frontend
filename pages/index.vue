            ...
            <v-row justify="center" align="center" class="fill-height">
                <v-col cols="12" md="8" lg="6" class="text-center">
                    <div class="welcome-content">
                        ...
                        <p class="text-body-1 mb-8 max-width-600 mx-auto">
                            Streamline attendance management for students,
                            lecturers, and administrators with our comprehensive
                            digital solution. Access your dashboard, track
                            attendance, and manage your academic activities
                            efficiently.
                        </p>
                            ...
                            <v-row>
                                <v-col cols="12" md="4">
                                    <div class="feature-item pa-4">
                                        ...
                                        >
                                            Real-time attendance tracking for
                                            all your classes
                                        </p>
                                    </div>
                                </v-col>
